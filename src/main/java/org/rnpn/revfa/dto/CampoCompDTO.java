...
public class CampoCompDTO {
  ...
  public List<DetalleSolicitudDTOSimple> detalleSolicitud;

  public CampoCompDTO() {}

  public CampoCompDTO(Campo campo) {
    this.id = campo.id;
    ...
    if (campo.detallesSolicitudes != null) {
      this.detalleSolicitud = campo.detallesSolicitudes.stream().map(DetalleSolicitudDTOSimple::new)
